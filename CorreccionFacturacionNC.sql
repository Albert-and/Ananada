...
SELECT
isnull(T6.baseref,'') as 'No. OV',
T0.cardcode 'No.Cliente',
T2.SlpCode 'Cod_vendedor',
T0.Doctotal 'TotalFactura',
T0.Docnum 'No.Factura',
T1.seriesname 'Serie',
T3.[ItemCode] 'SKU',
T3.[Quantity] 'Cantidad',
T3.[LineTotal] 'TotalLinea',
T0.DocDate 'FechaFactura',
...
WHEN 'PedEsp' THEN 'PedidosEspeciales'
...
WHERE T0.CANCELED = 'N' AND T0.DocDate >= '20240101'
